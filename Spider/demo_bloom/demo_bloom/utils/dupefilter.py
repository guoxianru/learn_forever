...
from scrapy_redis_bloomfilter.connection import get_redis_from_settings
...
class RFPDupeFilter(BaseDupeFilter):
    ...
    def request_seen(self, request):
        ...
        # if request.priority and self.bf.exists('temp_{}'.format()):
        if request.priority:
            added=self.server.sadd('temp_{}'.format(self.key),fp)
            return added ==0
